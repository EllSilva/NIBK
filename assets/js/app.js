...
import page_venda from './view/servicos/detalhe.js'
Vue.component('p-venda', page_venda)
...
const routes = [
    ...
    { path: '/servicos/vendas', component: { template: '<p-servicos></p-servicos>' } },
    { path: '/vendas/detalhe', component: { template: '<p-venda></p-venda>' } },
